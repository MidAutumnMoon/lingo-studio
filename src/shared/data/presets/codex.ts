 ...
 * (PKCE), instead of a platform API key. Unlike an external CLI login,
 * Codex is usable for normal chat and the app
 ...
 * catalog at runtime (no DB seeding needed). The row
